...
final class BestToolsSelector {
    ...
    record ToolDecision(Outcome outcome, @Nullable ItemStack tool) {
        private static final ToolDecision NOT_APPLICABLE_DECISION = new ToolDecision(Outcome.NOT_APPLICABLE, null);
     ...
     */
    static ToolDecision decide(Main main, BestToolsHandler handler, Player p, PlayerSetting playerSetting,
